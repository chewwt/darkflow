    ...
    for class_loop in range(class_length):
        for index in range(pred_length):
            ...
            for index2 in range(index+1,pred_length):
                ...
                if box_iou_c(final_bbox[index,0],final_bbox[index,1],final_bbox[index,2],final_bbox[index,3],final_bbox[index2,0],final_bbox[index2,1],final_bbox[index2,2],final_bbox[index2,3]) >= 0.3:
